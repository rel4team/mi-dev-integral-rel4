use sel4_common::{structures::exception_t, structures_gen::cap_irq_handler_cap};
...
pub fn invoke_irq_control(
    ...
    cte_insert(&cap_irq_handler_cap::new(irq as u64).unsplay(), control_slot, handler_slot);
